...
hero:
  ...
  actions:
    - theme: brand
      text: Play
      link: https://demo.catacombs.world

features:
  - title: Infinite
    details: An infinite dungeon ready to be explored
  - title: Persistent
    details: The catacombs never ends, we have no server to maintain
  - title: Composable
    details: Player can interact with the core ruleset in any way they want.
---
