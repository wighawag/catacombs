...
export default defineConfig({
	base: isRunningOnVercel ? '/' : '/catacombs/',
	title: 'Catacombs',
	description: 'Catacombs, Enter at your own risk',
	head: [
		[
			'script',
			{id: 'plausible'},
			`;(() => {
        if (location.hostname === 'catacombs.world') {
          const plausible_script = document.createElement('script');
          plausible_script.setAttribute('data-domain','catacombs.world');
		...
		['meta', {name: 'og:url', content: 'https://catacombs.world'}],
		...
		['meta', {name: 'og:image', content: 'https://catacombs.world/preview.png'}],

		['meta', {name: 'twitter:url', content: 'https://catacombs.world'}],
		...
		[
			...
			{
				name: 'twitter:image',
				content: 'https://catacombs.world/preview.png',
			},
		],
	],
	themeConfig: {
		...
		socialLinks: [
			{icon: 'github', link: 'https://github.com/wighawag/catacombs#readme'},
			{icon: 'twitter', link: 'https://twitter.com/catacombs_eth'},
	...
	transformHead: ({pageData}) => {
		const host = 'https://catacombs.world';
